...
void test_gravForce()
{
    ...
    Body body1(pos1, vel1, accel1, netForce1, 5.0, 1.0, 1.0, "planet", {}, {});
    Body body2(pos2, vel2, accel2, netForce2, 10.0, 1.0, 1.0, "planet", {}, {});
...
void test_applyForce()
{
    ...
    Body body(pos, vel, accel, netForce, 10.0, 1.0, 1.0, "planet", {}, {});
...
void test_update()
{
    ...
    Body body(pos, vel, accel, netForce, 1.0, 1.0, 1.0, "planet", {}, {});
    body.update(1.0);
...
void test_resetForce()
{
    Vector pos(0, 0, 0);
    Vector vel(0, 0, 0);
    Vector accel(0, 0, 0);
    Vector netForce(10.0, 0, 0);

    Body body(pos, vel, accel, netForce, 1.0, 1.0, 1.0, "planet", {}, {});
    body.resetForce();

    Vector expectedForce(0, 0, 0);
    assert_vector_equal(expectedForce, body.net_force, "Resetting net force");
}
